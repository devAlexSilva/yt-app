...
export const categories = [
  ...
  { name: 'Alanzoka', icon: <SportsEsportsIcon />, },
  ...
  { name: 'Filme', icon: <OndemandVideoIcon />, },
  { name: 'Jogos', icon: <SportsEsportsIcon />, },
  { name: 'Live', icon: <LiveTvIcon />, },
  { name: 'Esporte', icon: <FitnessCenterIcon />, },
  { name: 'Devaslife', icon: <CodeIcon />, },
  { name: 'Semântica', icon: <FaceRetouchingNaturalIcon />, },
  { name: 'Comedia', icon: <TheaterComedyIcon />, },
  { name: 'Rocketseat', icon: <CodeIcon />, },
